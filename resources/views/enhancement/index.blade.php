...
@section('body')
    ...
    <form method="post" action="{{route('enhancement.store', $customer->id)}}">
        @csrf
        ...
        <div class="form-row">
            ...
            <div class="col-md-3 mb-3">
                <label for="enhancement_status"><abbr title="enhancement_status"><strong>Renewal/Enhancement </strong></abbr></label>
                <select class="form-control select2bs4" required id="enhancement_status" style="width: 100%;" name="enhancement_status">
            ...
            <div class="col-md-3 mb-3">
                <label for="enhancement_amount"><strong>Amount</strong></label>
                <input type="number" class="form-control" step="0.01" min="0" id="enhancement_amount" required name="enhancement_amount">
            </div>
    ...
    <br>
    @if($customer->enhancement->isNotEmpty())
        ...
        <table class="table table-bordered border-collapse">
            ...
            <tbody>
            @foreach($customer->enhancement as $co)
                <tr>
                    <th scope="row">{{$loop->iteration}}</th>
                    <td>{{\Carbon\Carbon::parse($co->created_at)->format('d-m-Y')}}</td>
                    <td>{{$co->enhancement_status}}</td>
                    <td>{{$co->enhancement_amount}}</td>
                </tr>
            @endforeach
