...
@section('body')
    ...
    <form method="get" action="{{route('report.branchWiseNplToAdvances')}}">
    ...
    <h5 class="text-center font-weight-bold">The Bank of Azad Jammu & Kashmir
        <br> Branch Wise NPL TO Advances Ratio ({{$month->format('F - Y')}})
    </h5>
    <br>
    ...
    <table class="table table-bordered  ">
        ...
        <tr>
            ...
            <th scope="col" class="align-middle text-center" rowspan="2">Ratio</th>
            <th scope="col" class="align-middle text-center" colspan="2">{{$month->format('F, Y')}}</th>
        </tr>

        <tr>
            <th scope="col" class="align-middle text-center">Advances</th>
            <th scope="col" class="align-middle text-center">NPLs</th>
            <th scope="col" class="align-middle text-center">Advances</th>
            <th scope="col" class="align-middle text-center">NPLs</th>
        </thead>
        <tbody>
        @foreach($data as $key => $value)
            ...
            @if($key == "North Region")
                ...
                @foreach($value as $k => $v)
                    @if($k == "Muzaffarabad")
                        <tr>
                            <td colspan="7"><strong>{{$k}} Zone</strong></td>
                        </tr>
